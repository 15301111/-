		...
		<div id="main" class="alt">
			...
			<section id="one">
				<div class="inner">
					...
					<form name="addSHPOpinionForm" action="toApproving" method="post">
						...
						<table class="update" style="width: 600px;">
							...
							<tr>
								<td>&nbsp;<input name="approve" type="radio" value="true"
									style="resize: none;" checked="checked" /> 通过 <br />
								<br /> &nbsp;<input name="approve" type="radio"
									style="resize: none;" value="false" /> 拒绝
								</td>
