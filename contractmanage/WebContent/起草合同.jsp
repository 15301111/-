				...
				<div class="inner">
					...
					<form action="draft" method="post">
						<table class="update" style="width: 700px;">
							...
							<tr height="28">
								<td>用户:</td>
								<td><input type="text" name="customer" value="" /><font
									color="red">&nbsp;&nbsp;*</font></td>
							</tr>
							<tr>
								<td>开始时间:</td>
								<td><input type="text" id="beginTime" name="beginTime" /><font
									color="red">&nbsp;&nbsp;*正确格式 :yyyy-mm-dd</font></td>
							</tr>
							<tr>
								<td>结束时间:</td>
								<td><input type="text" id="endTime" name="endTime" /><font
									color="red">&nbsp;&nbsp;*正确格式 :yyyy-mm-dd</font></td>
							</tr>
							<tr>
								<td>违约惩罚:</td>
								<td><input type="text" id="chengfa" name="chengfa" /><font
									color="red">&nbsp;&nbsp;*</font></td>
							</tr>
							<tr>
								<td>内容:</td>
